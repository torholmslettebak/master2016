...
for i = 1:n
    [~, index] = max(fftFilter(infl_mat(:,i), 1, length(infl_mat(:,i)), 20, 1024, x_mat(:,i)));
...
xlabel('m');
ylabel('magnitude');
fileNameString = ['..\..\thesis\tikz\influenceLines\final_filtered_standard_averagedInfluenceline_sensor' num2str(sensor) '.tex' ];
