...
\begin{subfigure}[t]{0.45\textwidth}
	\centering
	\input{tikz/infl_matrix_train3.tex}
	\label{fig:train3}
\end{subfigure}
\qquad
\begin{subfigure}[t]{0.45\textwidth}
	\centering
	\input{tikz/infl_matrix_train4.tex}
	\label{fig:train4}
\end{subfigure}

\begin{subfigure}[t]{0.45\textwidth}
	\centering
	\input{tikz/infl_matrix_train5.tex}
	\label{fig:train5}
\end{subfigure}
\qquad
\begin{subfigure}[t]{0.45\textwidth}
	\centering
	\input{tikz/infl_matrix_train8.tex}
	\label{fig:train8}
\end{subfigure}
