...
% \includegraphics[width=0.8\pagewidth, angle=90]{./figures/nsb92.png}
% \caption{Axle distances of a NSB}
...
% \end{table}
\newpage
\chapter{Construction drawing of Lerelva bridge}
...
\chapter{Algorithms and code}
  \lstinputlisting{../code/matrixMethod/findInfluenceLines.m}
