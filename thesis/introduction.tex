...
Bridge weigh in motion, gives the abilty to determine traffic flow over a certain point, which may be more useful for the unregulated road traffic.
...
The goal of this master project.
